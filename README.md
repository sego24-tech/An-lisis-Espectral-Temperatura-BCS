...
# Estructura 
leer_datos.m &nbsp &nbsp # Lee el archivo de texto y realiza la limpieza de datos nulos.  
main.m &nbsp &nbsp &nbsp &nbsp &nbsp # Implementa la FFT y calcula el espectro de la magnitud.  
procesar_fft.m &nbsp &nbsp # Script principal que integra todo y ejecuta el análisis completo.  
